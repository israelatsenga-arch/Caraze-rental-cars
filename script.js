...
function calculateTotal() {
  ...
  // display result
    ...
    resultBox.textContent ="Dear " + name + ",your total will be  KES" + total +" please visit us at one of our branches so as to make the payment and get your luxurious car.";
